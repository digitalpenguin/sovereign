Sovereign.grid.AfricanArtworkJudges = function(config) {
    config = config || {};
    ...
    Ext.applyIf(config,{
        ...
        ,tbar:[{
            ...
            xtype: 'button'
            ,id: 'modx-filter-clear-africanartworksjudges'
            ,iconCls:'icon-reload'
            ,text: _('filter_clear')
            ,listeners: {
    ...
    Sovereign.grid.AfricanArtworkJudges.superclass.constructor.call(this,config)
};
Ext.extend(Sovereign.grid.AfricanArtworkJudges,MODx.grid.Grid,{
