Sovereign.grid.GalleryAfrican = function(config) {
    ...
    Ext.applyIf(config,{
        ...
        ,baseParams: { action: 'mgr/galleryafrican/submissions/getList' }
...
Ext.extend(Sovereign.grid.GalleryAfrican,MODx.grid.Grid,{
    search: function(tf,nv,ov) {
        ...
        this.getStore().baseParams = {
            action: 'mgr/galleryafrican/submissions/getList'
        ...
        MODx.msg.confirm({
            ...
            ,url: this.config.url
            ,params: {
                action: 'mgr/galleryafrican/submissions/remove'
...
Sovereign.window.UpdateGalleryAfrican = function(config) {
    ...
    Ext.applyIf(config,{
        ...
        ,url: Sovereign.config.connectorUrl
        ,baseParams: {
            action: 'mgr/galleryafrican/submissions/update'
        }
        ,fields: [{
            xtype: 'hidden'
            ,name: 'id'
...
Sovereign.window.CreateGalleryAfrican = function(config) {
    ...
    Ext.applyIf(config,{
        ...
        ,url: Sovereign.config.connectorUrl
        ,baseParams: {
            action: 'mgr/galleryafrican/submissions/create'
        }
        ,fields: [{
            xtype: 'textfield'
            ,fieldLabel: _('sovereign.name')
